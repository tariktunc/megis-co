...
export const answerBlock = '{{ANSWER_BLOCK}}'; // Must state plainly that the commission rate is user-entered from the seller's own Çiçeksepeti panel — never published or asserted by WebForge.

export const definitionBox = {
  term: '{{DEFINITION_TERM}}', // e.g. "Çiçeksepeti komisyon oranı"
