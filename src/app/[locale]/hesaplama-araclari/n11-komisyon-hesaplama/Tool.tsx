// Tool.tsx — n11-komisyon-hesaplama interactive component.
...
interface N11ToolState {
  purchasePrice: number;
  salePrice: number;
  vatRatePercent: number;
  /** User-entered, read from the seller's own n11 panel — never a WebForge-asserted rate (Rule 4). */
...
export function N11Tool() {
  const [state, update] = useToolState<N11ToolState>({
    purchasePrice: 0,
    salePrice: 0,
    vatRatePercent: 20,
    ...
    <div className="rounded-[1px] border border-border p-4 sm:p-6">
      ...
      <form className="flex flex-col gap-2" onSubmit={(e) => e.preventDefault()}>
        ...
        <NumberField
          ...
          min={0}
          max={100}
          helperText="Satıcı panelinizdeki n11 komisyon oranını girin."
          required
        />
