...
export const answerBlock = '{{ANSWER_BLOCK}}'; // Must state plainly that the commission rate is user-entered from the seller's own Hepsiburada panel — never published or asserted by WebForge.

export const definitionBox = {
  term: '{{DEFINITION_TERM}}', // e.g. "Hepsiburada komisyon oranı"
