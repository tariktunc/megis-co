...
export const answerBlock = '{{ANSWER_BLOCK}}'; // Must state plainly that the commission rate is user-entered from the seller's own Amazon panel — never published or asserted by WebForge.

export const definitionBox = {
  term: '{{DEFINITION_TERM}}', // e.g. "Amazon komisyon oranı"
